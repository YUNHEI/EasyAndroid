...
public class FlowLayout extends ViewGroup {
    ...
    public FlowLayout(Context context, AttributeSet attrs) {
        ...
        mVerticalSpacing = ta.getDimensionPixelSize(R.styleable.FlowLayout_vertical_spacing, 0);
        mHorizontalSpacing = ta.getDimensionPixelSize(R.styleable.FlowLayout_horizontal_spacing, 0);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0, childCount = getChildCount(); i < childCount; ++i) {
            ...
            if (childLeft + childWidth + paddingRight > selfWidth) {
                childLeft = (int) (childWidth + mHorizontalSpacing);
