...
class ChatImageViewerFragment : BaseSimpleFragment() {
    ...
    val messages: MutableList<Message> by lazy { Message.fromJsonToCollection(argString("messages")).toMutableList() }
    ...
    internal inner class ImagePagerAdapter(fm: FragmentManager) : FragmentPagerAdapter(fm, BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT) {
