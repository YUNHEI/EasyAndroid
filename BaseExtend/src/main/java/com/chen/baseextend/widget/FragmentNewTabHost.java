...
public class FragmentNewTabHost extends TabHost
    ...
    private OnTabChangeListener mOnTabPreChangeListener;
    ...
    public FragmentNewTabHost(@NonNull Context context) {
    ...
    public FragmentNewTabHost(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setOnTabPreChangedListener(@Nullable OnTabChangeListener l) {
        mOnTabPreChangeListener = l;
    }
    ...
    public void onTabChanged(@Nullable String tabId) {
        ...
        if (mOnTabPreChangeListener != null) {
            mOnTabPreChangeListener.onTabChanged(tabId);
        }
