...
package com.chen.baseextend.widget.banner.transformer;
...
public abstract class ABaseTransformer implements PageTransformer {
	 ...
	 * not modify the same page properties. For INS changing from a transformation that applies rotation to a
