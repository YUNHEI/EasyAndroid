package com.chen.baseextend.widget.photopicker;
...
public class PhotoPicker {
  ...
  public static final int REQUEST_CODE_URL             = 234;
   ...
   * 是否展示选取（多选）
   */
  public final static String EXTRA_SHOW_SELECT = "SHOW_SELECT";
  ...
  public static class PhotoPickerBuilder {
    ...
    /**
     * Send the Intent from an Activity with a custom request certificateCode
     *
    ...
    /**
     * Send the Intent with a custom request certificateCode
     *
     * @param fragment    Fragment to receive result
     */
    public void start(@NonNull Context context,
    ...
    public PhotoPickerBuilder setIsShowSelect(boolean isShow) {
      mPickerOptionsBundle.putBoolean(EXTRA_SHOW_SELECT, isShow);
      return this;
    }

    public PhotoPickerBuilder setUrls(ArrayList<String> urls) {
      mPickerOptionsBundle.putStringArrayList(EXTRA_URL, urls);
      return this;
    }
  }
}
