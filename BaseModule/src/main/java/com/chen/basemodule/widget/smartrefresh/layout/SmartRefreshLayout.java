package com.chen.basemodule.widget.smartrefresh.layout;
...
import com.chen.basemodule.widget.smartrefresh.layout.impl.ScrollBoundaryDeciderAdapter;
import com.chen.basemodule.widget.smartrefresh.layout.listener.SimpleMultiPurposeListener;
import com.chen.basemodule.R;
import com.chen.basemodule.widget.smartrefresh.layout.api.DefaultRefreshFooterCreator;
import com.chen.basemodule.widget.smartrefresh.layout.api.DefaultRefreshHeaderCreator;
import com.chen.basemodule.widget.smartrefresh.layout.api.DefaultRefreshInitializer;
import com.chen.basemodule.widget.smartrefresh.layout.api.RefreshContent;
import com.chen.basemodule.widget.smartrefresh.layout.api.RefreshFooter;
import com.chen.basemodule.widget.smartrefresh.layout.api.RefreshHeader;
import com.chen.basemodule.widget.smartrefresh.layout.api.RefreshInternal;
import com.chen.basemodule.widget.smartrefresh.layout.api.RefreshKernel;
import com.chen.basemodule.widget.smartrefresh.layout.api.RefreshLayout;
import com.chen.basemodule.widget.smartrefresh.layout.api.ScrollBoundaryDecider;
import com.chen.basemodule.widget.smartrefresh.layout.constant.DimensionStatus;
...
import com.chen.basemodule.widget.smartrefresh.layout.footer.BallPulseFooter;
import com.chen.basemodule.widget.smartrefresh.layout.header.BezierRadarHeader;
import com.chen.basemodule.widget.smartrefresh.layout.impl.RefreshContentWrapper;
import com.chen.basemodule.widget.smartrefresh.layout.impl.RefreshFooterWrapper;
import com.chen.basemodule.widget.smartrefresh.layout.impl.RefreshHeaderWrapper;
import com.chen.basemodule.widget.smartrefresh.layout.listener.OnLoadMoreListener;
import com.chen.basemodule.widget.smartrefresh.layout.listener.OnMultiPurposeListener;
import com.chen.basemodule.widget.smartrefresh.layout.listener.OnRefreshListener;
import com.chen.basemodule.widget.smartrefresh.layout.listener.OnRefreshLoadMoreListener;
import com.chen.basemodule.widget.smartrefresh.layout.listener.OnStateChangedListener;
import com.chen.basemodule.widget.smartrefresh.layout.util.DelayedRunnable;
import com.chen.basemodule.widget.smartrefresh.layout.util.DensityUtil;
import com.chen.basemodule.widget.smartrefresh.layout.util.ScrollBoundaryUtil;
import com.chen.basemodule.widget.smartrefresh.layout.util.ViscousFluidInterpolator;
...
import static com.chen.basemodule.widget.smartrefresh.layout.util.DensityUtil.dp2px;
import static com.chen.basemodule.widget.smartrefresh.layout.util.SmartUtil.fling;
import static com.chen.basemodule.widget.smartrefresh.layout.util.SmartUtil.getColor;
import static com.chen.basemodule.widget.smartrefresh.layout.util.SmartUtil.isContentView;
...
//            reboundAnimator.setDuration(20000);
    ...
    AnimatorUpdateListener auListener;

    AnimatorListenerAdapter aListener;

    public void addReboundAnimatorListener(AnimatorUpdateListener auListener) {
        this.auListener = auListener;
    }

    public void addAnimatorListener(AnimatorListenerAdapter aListener) {
                ...
                if (mState == RefreshState.Refreshing && mRefreshHeader != null && mRefreshContent != null) {
                    ...
                    if (startDelay < Integer.MAX_VALUE) {
                        ...
                        if (mSpinner > 0) {
                            ...
                            if (aListener != null)
                                mKernel.moveSpinner(DensityUtil.dp2px(36), false);

                            if (aListener != null) aListener.onAnimationStart(null);

                            AnimatorUpdateListener updateListener = null;

                            startDelay = (aListener != null) ? startDelay : 0;
                            ...
                            if (valueAnimator != null) {
                                ...
                                if (aListener != null && auListener != null) {
                                    valueAnimator.addListener(aListener);

                                    valueAnimator.addUpdateListener(auListener);
                                }
...
//        }
    ...
    //<editor-fold desc="滑块 暂不启用 computeVerticalScroll">


//    @Override
//    protected int computeVerticalScrollExtent() {
//
//        return computeVerticalScrollRange() / getChildCount();
//    }
//
//    @Override
//    protected int computeVerticalScrollOffset() {
//
//        return Math.max(0, mScroller.getCurrY());
//    }
//
//    @Override
