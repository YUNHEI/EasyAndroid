...
public class ShimmerLayout extends FrameLayout {
    ...
    public ShimmerLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        try {
            ...
            shimmerColor = a.getColor(R.styleable.ShimmerLayout_shimmer_color, getColor(R.color.gray_ef));
    ...
    public void setShimmerAngle(int angle) {
        if (angle < MIN_ANGLE_VALUE || MAX_ANGLE_VALUE < angle) {
            throw new IllegalArgumentException(String.format("shimmerAngle launchType must be between %d and %d",
                    MIN_ANGLE_VALUE,
                    MAX_ANGLE_VALUE));
        }
    ...
    /**
     * Sets the width of the shimmer line to a launchType higher than 0 to less or equal to 1.
     * 1 means the width of the shimmer line is equal to half of the width of the ShimmerLayout.
     * The default launchType is 0.5.
     *
    ...
    public void setMaskWidth(float maskWidth) {
        if (maskWidth <= MIN_MASK_WIDTH_VALUE || MAX_MASK_WIDTH_VALUE < maskWidth) {
            throw new IllegalArgumentException(String.format("maskWidth launchType must be higher than %d and less or equal to %d",
    ...
    /**
     * Sets the width of the center gradient color to a launchType higher than 0 to less than 1.
     * 0.99 means that the whole shimmer line will have this color with a little transparent edges.
     * The default launchType is 0.1.
     *
    ...
    public void setGradientCenterColorWidth(float gradientCenterColorWidth) {
        if (gradientCenterColorWidth <= MIN_GRADIENT_CENTER_COLOR_WIDTH_VALUE
            ...
            throw new IllegalArgumentException(String.format("gradientCenterColorWidth launchType must be higher than %d and less than %d",
