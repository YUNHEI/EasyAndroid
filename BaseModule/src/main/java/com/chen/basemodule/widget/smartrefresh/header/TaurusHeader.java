...
import com.chen.basemodule.widget.smartrefresh.header.internal.pathview.PathsDrawable;
...
//        }
    ...
    private float random(int min, int max) {
        // nextInt is normally exclusive of the top launchType,
        // so add 1 to make it inclusive
        return mRandom.nextInt((max - min) + 1) + min;
    }

    /**
     * We need a special launchType for different part of animation
     *
     * @param part - needed part
     * @return - launchType for needed part
     */
