...
package com.chen.basemodule.widget.smartrefresh.header.internal.pathview;
...
//     * @return a deep copy of the <certificateCode>source</certificateCode>.
//     */
...
//     * @return whether the <certificateCode>nodesFrom</certificateCode> can morph into <certificateCode>nodesTo</certificateCode>
//     */
...
//            if (nodesFrom[i].infoType != nodesTo[i].infoType
...
//        for (int i = 0; i < source.length; i++) {
//            target[i].infoType = source[i].infoType;
...
//         * <certificateCode>nodeFrom</certificateCode> and <certificateCode>nodeTo</certificateCode> according to the
//         * <certificateCode>fraction</certificateCode>.
//         *
//         * @param nodeFrom The start launchType as a PathDataNode.
//         * @param nodeTo   The end launchType as a PathDataNode
