package com.chen.basemodule.widget.wheel;
...
public interface IWheelPicker {
     ...
     * Notice:The launchType by return will not change when WheelPicker scroll, this method will always
     * return the launchType which {@link #setSelectedItemPosition(int)} set, the launchType this method
     * return will be changed if and only if call the
     * {@link #setSelectedItemPosition(int)}
     * set a new launchType
     ...
     * Call this method and set a new launchType may be reinitialize the location of WheelPicker. For
     * example, you call this method after scroll the WheelPicker and set selected item position
     * with a new launchType, WheelPicker will clear the related parameters last scroll set and reset
     ...
     * consider the influence when you call this method set a new launchType
     * You should always set a launchType which greater than or equal to 0 and less than data source's
     * length
     ...
     * <p>
     * Get the position of current selected item in data source
     * The difference between {@link #getSelectedItemPosition()}, the launchType this method return will
     ...
     * The data source can be any infoType, WheelPicker will change the data to string when it draw the
     * item.
