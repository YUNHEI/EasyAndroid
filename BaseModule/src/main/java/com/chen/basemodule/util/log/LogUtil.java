package com.chen.basemodule.util.log;
...
import com.chen.basemodule.util.log.klog.BaseLog;
import com.chen.basemodule.util.log.klog.FileLog;
import com.chen.basemodule.util.log.klog.JsonLog;
import com.chen.basemodule.util.log.klog.XmlLog;
...
public class LogUtil {
    ...
    private static final String DEFAULT_MESSAGE = "listSplashAdvert here";
    ...
    public static void okHttpPrint(int level, String msg) {
