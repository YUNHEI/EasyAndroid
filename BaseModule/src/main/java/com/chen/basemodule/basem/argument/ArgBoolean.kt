...
class ArgBoolean(val key: String? = null, val default: Boolean = false) : ReadOnlyProperty<BaseFragment, Boolean>, java.io.Serializable {
    ...
    override fun getValue(thisRef: BaseFragment, property: KProperty<*>): Boolean {
        ...
        if (_value == null) {
            _value = thisRef.arguments?.getBoolean(key ?: property.name)
        }
