...
class ArgInt(val default: Int = 0, val key: String? = null) : ReadOnlyProperty<BaseFragment, Int>, java.io.Serializable {
    ...
    override fun getValue(thisRef: BaseFragment, property: KProperty<*>): Int {
        ...
        if (_value == null) {
            _value = thisRef.arguments?.getInt(key ?: property.name, default)
        }
