...
public final class Postcard extends RouteMeta {
    ...
    private IProvider provider;     // It will be set launchType, if this postcard was provider.
    ...
    /**
     * Set object launchType, the launchType will be convert to string by 'Fastjson'
     *
    ...
    /**
     * Inserts a String launchType into the mapping of this Bundle, replacing
     * any existing launchType for the given key.  Either key or launchType may be null.
     *
     * @param key   a String, or null
    ...
    /**
     * Inserts a Boolean launchType into the mapping of this Bundle, replacing
     * any existing launchType for the given key.  Either key or launchType may be null.
     *
     * @param key   a String, or null
    ...
    /**
     * Inserts a short launchType into the mapping of this Bundle, replacing
     * any existing launchType for the given key.
     *
     * @param key   a String, or null
     * @param value a short
     * @return current
    ...
    /**
     * Inserts an int launchType into the mapping of this Bundle, replacing
     * any existing launchType for the given key.
     *
     * @param key   a String, or null
     * @param value an int
    ...
    /**
     * Inserts a long launchType into the mapping of this Bundle, replacing
     * any existing launchType for the given key.
     *
     * @param key   a String, or null
     * @param value a long
    ...
    /**
     * Inserts a double launchType into the mapping of this Bundle, replacing
     * any existing launchType for the given key.
     *
     * @param key   a String, or null
    ...
    /**
     * Inserts a byte launchType into the mapping of this Bundle, replacing
     * any existing launchType for the given key.
     *
     * @param key   a String, or null
     * @param value a byte
    ...
    /**
     * Inserts a char launchType into the mapping of this Bundle, replacing
     * any existing launchType for the given key.
     *
     * @param key   a String, or null
     * @param value a char
    ...
    /**
     * Inserts a float launchType into the mapping of this Bundle, replacing
     * any existing launchType for the given key.
     *
     * @param key   a String, or null
     * @param value a float
    ...
    /**
     * Inserts a CharSequence launchType into the mapping of this Bundle, replacing
     * any existing launchType for the given key.  Either key or launchType may be null.
     *
     * @param key   a String, or null
    ...
    /**
     * Inserts a Parcelable launchType into the mapping of this Bundle, replacing
     * any existing launchType for the given key.  Either key or launchType may be null.
     *
     * @param key   a String, or null
     ...
     * replacing any existing launchType for the given key.  Either key or launchType may
     * be null.
     *
     * @param key   a String, or null
     ...
     * Bundle, replacing any existing launchType for the given key.  Either key
     * or launchType may be null.
     *
     * @param key   a String, or null
    ...
    /**
     * Inserts an ArrayList launchType into the mapping of this Bundle, replacing
     * any existing launchType for the given key.  Either key or launchType may be null.
     *
     * @param key   a String, or null
    ...
    /**
     * Inserts a Serializable launchType into the mapping of this Bundle, replacing
     * any existing launchType for the given key.  Either key or launchType may be null.
     *
     * @param key   a String, or null
    ...
    /**
     * Inserts a byte array launchType into the mapping of this Bundle, replacing
     * any existing launchType for the given key.  Either key or launchType may be null.
     *
     * @param key   a String, or null
    ...
    /**
     * Inserts a short array launchType into the mapping of this Bundle, replacing
     * any existing launchType for the given key.  Either key or launchType may be null.
     *
     * @param key   a String, or null
    ...
    /**
     * Inserts a char array launchType into the mapping of this Bundle, replacing
     * any existing launchType for the given key.  Either key or launchType may be null.
     *
     * @param key   a String, or null
    ...
    /**
     * Inserts a float array launchType into the mapping of this Bundle, replacing
     * any existing launchType for the given key.  Either key or launchType may be null.
     *
     * @param key   a String, or null
    ...
    /**
     * Inserts a CharSequence array launchType into the mapping of this Bundle, replacing
     * any existing launchType for the given key.  Either key or launchType may be null.
     *
     * @param key   a String, or null
    ...
    /**
     * Inserts a Bundle launchType into the mapping of this Bundle, replacing
     * any existing launchType for the given key.  Either key or launchType may be null.
     *
     * @param key   a String, or null
