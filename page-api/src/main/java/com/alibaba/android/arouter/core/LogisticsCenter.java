...
//                        ((IInterceptorGroup) (Class.forName(className).getConstructor().newInstance())).loadInto(Warehouse.interceptorsIndex);
    ...
    public synchronized static void completion(Postcard postcard) {
        ...
        if (null == routeMeta) {    // Maybe its does't exist, or didn't load.
            ...
            postcard.setLaunchType(routeMeta.getLaunchType());
            postcard.setSwipeType(routeMeta.getSwipeType());
            ...
            if (null != rawUri) {   // Try to set params into bundle.
                ...
                if (MapUtils.isNotEmpty(paramsType)) {
                    // Set launchType by its type, just for params which annotation by @Param
    ...
    /**
     * Set launchType by known type
     *
     * @param postcard postcard
     * @param typeDef  type
     * @param key      key
     * @param value    launchType
     */
        ...
        try {
            if (null != typeDef) {
                if (typeDef == TypeKind.BOOLEAN.ordinal()) {
                    ...
                    // TO  DO : How to description parcelable launchType with string?
