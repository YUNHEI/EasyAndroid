...
import com.chen.basemodule.mlist.layoutmanager.BannerLayoutManager
import com.chen.basemodule.network.base.BaseRequest
import com.chen.basemodule.network.base.BaseResponse
import kotlinx.android.synthetic.main.item_title.view.*

@Launch
class BannerListSampleFragment : SingleListFragment<WeatherBean>() {
    ...
    override val lManager: RecyclerView.LayoutManager by lazy { BannerLayoutManager(context, mRecycler, 5, RecyclerView.HORIZONTAL) }
